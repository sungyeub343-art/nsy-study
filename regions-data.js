...
const fallbackRegions = [
  ...
  {"province":"대구광역시","cities":["중구","동구","서구","남구","북구","수성구","달서구","달성군","군위군"]},
  {"province":"인천광역시","cities":["중구","동구","미추홀구","연수구","남동구","부평구","계양구","서구","강화군","옹진군"]},
  {"province":"전남광주통합특별시","cities":["동구","서구","남구","북구","광산구","목포시","여수시","순천시","나주시","광양시","담양군","곡성군","구례군","고흥군","보성군","화순군","장흥군","강진군","해남군","영암군","무안군","함평군","영광군","장성군","완도군","진도군","신안군"]},
...
function getProvinceLabel(province){
  ...
  if(province === '전남광주통합특별시') return '전남·광주';
